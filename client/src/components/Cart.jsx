      ...
      <div className="flex-1 flex flex-col items-start justify-start rounded-t-3xl bg-zinc-900 h-full py-6  gap-3 relative">
        {cart && cart?.length > 0 ? (
          <>
            ...
            <div className="bg-zinc-800 rounded-t-[60px] w-full h-[35%]">
              ...
              <motion.button
                {...buttonClick}
                className="bg-orange-400 w-[70%] px-4 py-3 text-xl text-headingColor font-semibold hover:bg-orange-500 drop-shadow-md rounded-2xl mt-2 ms-16"
          ...
          <>
            <h1 class="ms-12 mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
              <span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400 animate-pulse">
                Cart is Empty!
              </span>
            </h1>
            <p class=" ms-8 text-lg font-semibold text-yellow-500 lg:text-2xl dark:text-gray-400 animate-bounce">
              Your cart is in zen mode, perfectly empty and waiting. Add items
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-start gap-1 w-full">
        ...
        <p className="text-lg flex items-center justify-center gap-1 font-semibold text-red-500 ml-auto">
