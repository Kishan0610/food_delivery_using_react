  ...
  return (
    <header className="fixed backdrop-blur-md z-50 inset-x-0 top-0 flex items-center justify-between px-12 md:px-20 py-6">
      <NavLink to={"/"} className="flex items-center justify-center gap-4">
        ...
        <p className="font-semibold text-3xl hover:animate-pulse">Eat-Now</p>
      </NavLink>
            ...
            >
              ...
              {isMenu && (
                <motion.div
                  ...
                  className="px-6 py-4 w-48 bg-slate-50 backdrop-blur-md rounded-md shadow-md absolute top-12 right-0 flex flex-col gap-4"
                >
